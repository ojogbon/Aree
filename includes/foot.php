<footer>
      ...
      <section class="padding background-dark full-width">
        <div class="s-12 l-6">
          <p class="text-size-12">Copyright <script>" "+document.write(new Date().getFullYear());</script>, Aree Culture</p>
          
        </div>
        <div class="s-12 l-6">
          <a class="right text-size-12" href="http://www.capriquota.com" title="CQT">Developed <br> by capriquota</a>
        </div>
      </section>
    </footer>