...
<head>
    ...
    <title> <?php echo $companyname;?> | Gallery</title>
                        ...
                        <div class="page-header">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class=""><a href="staff.php">Gallery</a></li>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card alert">
                                    ...
                                    <div class="basic-form">
                                        <form method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                <p>Gallery Title </p>
                                                <input type="text" name="galleryTitle" class="form-control input-default " placeholder="Gallery Title" required>
                                            </div>
								...
								<button type="submit" name="add_staff" class="btn btn-primary btn-flat m-b-30 m-t-30">Add Gallery</button>
                                        </form>
                                        <?php
                                                    			 if(isset($_POST["add_staff"])){
                                                                    ...
                                                                    $key = "1234567opiuyt";
                                                                    insertGallery($gallery,$key, $staff_id, $galleryTitle,$fileUpload);
                                                                    }
                                                    ?>
                                    </div>
                                </div>
...
<script>
    document.querySelector(".GalleryTypeIt").addEventListener("click",eve =>{
       let selectedType = document.querySelector(".GalleryTypeIt").selectedOptions[0].value;
